...
function MentorForm() {
    ...
    return (
        <form onSubmit = {handleSubmit}>
            ...
            <div className="mb-3">
                <label htmlFor="name" className="form-label">Mentor Name <span style={{color: "red"}}>*</span></label><br />
                <input type="text" className="form-control" id="name" value={name} onChange={(e)=>{setname(e.target.value)}} />
            </div><br />
            <div className="mb-3">
                <label htmlFor="email" className="form-label">Email <span style={{color: "red"}}>*</span></label><br />
                <input type="email" className="form-control" id="email" value={email} onChange={(e)=>{setemail(e.target.value)}} />
            </div><br />
            <div className="mb-3">
                <label htmlFor="course" className="form-label">Course <span style={{color: "red"}}>*</span></label><br />
